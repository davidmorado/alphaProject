...
x_train2, y_train2 = percentage_splitter(x_train, x_val, y_train, y_val, merging=True, random_selection=False, ratio=0.75) 
...
filename = '5. proto_cifar10_75_resnet_graph.pkl'
lr = 0.001
