...
MEMORY=0 # whether to use memory or not

srun /home/kurzendo/miniconda3/envs/GPU/bin/python /home/kurzendo/srp/varkeys/src/CNN+TrainingRatio/cnn_cache.py $LR  $MEMORY 
