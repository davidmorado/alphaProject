...
print("CNN+Keys...")
model1 = CNN_keys(layers=[32, 64, 512], embedding_dim = ed, num_classes=10, n_keys= n_keys, bandwidth=b, V=V)
scores_train1, scores_test1 = fit_evaluate( model1, x_train_, y_train_, x_test, y_test, batch_size, epochs, l, sigma=s, custom=1)
...
print("CNN...")
model2 = CNN(layers=[32, 64, 512], embedding_dim = ed, num_classes=10)
scores_train2, scores_test2 = fit_evaluate( model2, x_train_, y_train_, x_test, y_test, batch_size, epochs, l, sigma=s, custom=0)
