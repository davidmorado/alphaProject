...
modelpath = F'Adadelta_bw={bandwidth}_kpc={n_keys_per_class}_es={embedding_dim}_tp={p}'

results = fit_evaluate(model, x_train_, y_train_, x_test, y_test, batch_size, epochs, logstring=F'tb_logs/{modelpath}')
