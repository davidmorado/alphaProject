...
epochs = 100
n_output = 10
embedding_dim = [20, 50, 100, 500, 1000, 5000]
n_keys_per_class = [1, 10, 50, 100, 500]
bandwidth = [1, 10, 1000, 10000, 100000]
...
for b in bandwidth:
  for l in lr:
      for ed in embedding_dim:
        for nk in n_keys_per_class:
          
          print("Paramaters ... B: ", b," L: ", l, " ED: ",ed, "NK:", nk )
          ...
          fit_evaluate( model1, x_train, y_train, x_val, y_val, batch_size, epochs, l)


          print("CNN...")
          model2 = CNN(layers=[32, 64, 512], embedding_dim = ed, num_classes=10)
          fit_evaluate( model2, x_train, y_train, x_val, y_val, batch_size, epochs, l)