# -*- coding: utf-8 -*-
"""
Created on Tue Jun 11 09:51:04 2019
...
data_train = Omniglot('~/pytorch_data', train=True, download=True)
...
omniglot_train = tfds.load(name="omniglot")
omniglot_train = tfds.load(name="omniglot", split=tfds.Split.TRAIN)

from scipy import misc
import glob

for image_path in glob.glob("C:/Users/falcoxman2/Desktop/Hildesheim/Master/Project/Datasets/Omniglot/images_background/Alphabet_of_the_Magi/*.png"):
    image = misc.imread(image_path)
    print(image.shape)
    print (image.dtype)

assert isinstance(omniglot_train, tf.data.Dataset)
omniglot_train


builder = tfds.builder("omniglot")
assert builder.info.splits['train']
...
o_train = tfds.load(name="omnigplot", split=tfds.Split.TRAIN)
assert isinstance(o_train, tf.data.Dataset)
print(o_train)
